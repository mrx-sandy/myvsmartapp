    ...
    <div className="footer-row">
      <div className="col-sm-6 col-xl-2">
        <div className="footer-widget">
          ...
          <p className="footer-desc">Vishwakarma Super Mart Private Limited, <br></br>is a direct selling company
            that deals with the distribution of a wide range of high quality, <br></br>lifestyle products for day
            to day life.</p>
        ...
        <div className="footer-widget contact">
          ...
          <ul className="footer-contact">
            <li><i className="icofont-ui-email" />
              <p><a className="link-secondary" href="mailto:vsmart0932@gmail.com"><span>sandipgadekar143@gmail.com</span></a></p>
            </li>
            <li><i className="icofont-ui-touch-phone" />
              <p> <a className="link-secondary" href="tel:7057921848"><span>+91 7057921848</span></a></p>
            </li>
            <li><i className="icofont-location-pin" />
              <p>A/P Koregaon, 2978 Jalgaon Road,
                Tal - Koregaon, Dist. Satara <br></br> Pin 415501</p>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="row">
      <div className="col-12">
        <div className="footer-bottom">
          ...
          <p className="footer-copytext"> Designed by <a target="blank" href="https://www.ajspire.com">Sandip
              Gadekar
              Pvt.Ltd </a> </p>
        </div>
      </div>
